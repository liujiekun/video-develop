<template>
  <div>
    ...
    <el-row>
      ...
      <el-button @click="changeTitle">改变title</el-button>
      <el-button @click="changeBody">改变内容</el-button>
...
export default {
  ...
  methods: {
    ...
    changeTitle () {
      console.log('config', this.popupPlugin, this.popupPlugin._config)
      for (let key in this.popupPlugin._config) {
        console.log(key, this.popupPlugin._config[key])
      }
    }
  },
  computed: {
